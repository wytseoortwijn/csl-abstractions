...
makefile.conf: 
	coq_makefile -o makefile Assertions.v HahnBase.v HeapSolver.v Heaps.v PermSolver.v Permissions.v PermutationTactic.v Prelude.v ProcMap.v ProcMapSolver.v Process.v Programs.v Soundness.v
